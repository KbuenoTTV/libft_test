...
/*   Updated: 2015/01/04 09:57:08 by jchichep         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int start()
{
	...
	if (FT_BZERO == true && seg < 2)
	{
		...
		/* TEST 1 */
		printf("ft_bzero.c [TEST = \"0123456789\"] :  \t\t ");
		bzero (str1, 5);
		ft_bzero (str2, 5);
		...
		/* TEST 2 */
		printf("ft_bzero.c [TEST = \"\\0\\0\\0\\0\\056789\"] :  \t ");
		bzero (str1, 7);
		ft_bzero (str2, 7);
		if (memcmp(str1, str2, 11) == 0)
			printf("\033[32mCorrecte\033[0m\n");
	...
	if (FT_ISALNUM == true && seg < 3)
	{
		...
		msg = "ft_isalnum.c [TEST = '%d'] :  \t\t\t ";

		/* Test 1-600 */
		while (++idx < 300)
		{
			if ((nb1 = isalnum(idx)) != (nb2 = ft_isalnum(idx)))
			{
	...
	if (FT_ISALPHA == true && seg < 4)
	{
		...
		printf("TESTED VALUE ARE BEETWEEN -300 & 300\n");
		msg = "ft_isalpha.c [TEST = '%d'] :  \t\t ";
		str = NULL;
		/* Test 1-600 */
		while (++idx < 300)
		{
			if ((nb1 = isalpha(idx)) != (nb2 = ft_isalpha(idx)))
			{
